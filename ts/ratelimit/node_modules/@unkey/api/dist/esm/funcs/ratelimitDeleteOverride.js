...
export function ratelimitDeleteOverride(client, request, options) {
    return new APIPromise($do(client, request, options));
}
async function $do(client, request, options) {
    const parsed = safeParse(request, (value) => components.V2RatelimitDeleteOverrideRequestBody$outboundSchema.parse(value), "Input validation failed");
    if (!parsed.ok) {
