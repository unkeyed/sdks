...
with Unkey(
    ...
    res = unkey.apps.list_apps(project="proj_1234abcd", limit=100, cursor="app_1234abcd", search="checkout")
...
with Unkey(
    ...
    res = unkey.apps.list_apps(project="payments-service", limit=100, cursor="app_1234abcd", search="checkout")
...
| `search`                                                                                                                      | *Optional[str]*                                                                                                               | :heavy_minus_sign:                                                                                                            | Free-form text to filter apps. Returns apps whose ID, name, or slug contains the search string. Matching is case-insensitive. | checkout                                                                                                                      |
| `retries`                                                                                                                     | [Optional[utils.RetryConfig]](../../models/utils/retryconfig.md)                                                              | :heavy_minus_sign:                                                                                                            | Configuration to override the default retry behavior of the client.                                                           |                                                                                                                               |
