...
with Unkey(
    ...
    res = unkey.environments.update_settings(project="proj_1234abcd", app="proj_1234abcd", environment="proj_1234abcd", dockerfile="./Dockerfile", root_directory=".", build_command="pnpm --filter api build", auto_deploy=True, port=8080, v_cpus=1.0, memory_mib=512, storage_mib=1024, healthcheck={
...
with Unkey(
    ...
    res = unkey.environments.update_settings(project="payments", app="payments-api", environment="production", dockerfile="./Dockerfile", root_directory=".", build_command="pnpm --filter api build", auto_deploy=True, port=8080, v_cpus=1.0, memory_mib=512, storage_mib=1024, healthcheck={
        "method": models.EnvironmentHealthcheckMethod.GET,
        "path": "/healthz",
        "interval_seconds": 10,
        "timeout_seconds": 2,
...
with Unkey(
    ...
    res = unkey.environments.update_settings(project="payments", app="payments-api", environment="production", dockerfile="./Dockerfile", root_directory=".", build_command="pnpm --filter api build", auto_deploy=True, port=8080, v_cpus=2.0, memory_mib=1024, storage_mib=1024, healthcheck={
        "method": models.EnvironmentHealthcheckMethod.GET,
        "path": "/healthz",
        "interval_seconds": 10,
        "timeout_seconds": 2,
