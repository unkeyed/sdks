...
class V2RatelimitMultiLimitCheckTypedDict(TypedDict):
    namespace: str
    r"""The namespace this rate limit result corresponds to. Use this field to correlate the response with the request when checking multiple rate limits."""
    identifier: str
    r"""The identifier this rate limit result corresponds to. Use this field to correlate the response with the request when checking multiple rate limits."""
    limit: int
...
class V2RatelimitMultiLimitCheck(BaseModel):
    namespace: str
    r"""The namespace this rate limit result corresponds to. Use this field to correlate the response with the request when checking multiple rate limits."""
    ...
    def serialize_model(self, handler):
        optional_fields = set(["overrideId"])
...
try:
    V2RatelimitMultiLimitCheck.model_rebuild()
except NameError:
    pass
