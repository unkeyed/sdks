...
class V2IdentitiesDeleteIdentityResponseBodyTypedDict(TypedDict):
    r"""Empty response object. A successful response indicates the identity was deleted successfully."""
...
class V2IdentitiesDeleteIdentityResponseBody(BaseModel):
    r"""Empty response object. A successful response indicates the identity was deleted successfully."""
