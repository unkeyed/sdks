...
class V2KeysMigrateKeyDataTypedDict(TypedDict):
    hash: str
    r"""The current hash of the key on your side"""
...
class V2KeysMigrateKeyData(BaseModel):
    hash: str
    r"""The current hash of the key on your side"""
...
try:
    V2KeysMigrateKeyData.model_rebuild()
except NameError:
    pass
