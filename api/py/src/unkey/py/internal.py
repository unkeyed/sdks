...
class Internal(BaseSDK):
    def create_deployment(
        ...
        *,
        ...
        git_commit: Optional[
            Union[models.V2DeployGitCommit, models.V2DeployGitCommitTypedDict]
        ] = None,
        ...
        **Authentication**: Requires a valid root key with appropriate permissions.
        ...
        :param project_id: Unkey project ID
        ...
        request = models.V2DeployCreateDeploymentRequestBody(
            project_id=project_id,
            keyspace_id=keyspace_id,
            branch=branch,
            environment_slug=environment_slug,
            docker_image=docker_image,
            git_commit=utils.get_pydantic_model(
                git_commit, Optional[models.V2DeployGitCommit]
            ),
        )
