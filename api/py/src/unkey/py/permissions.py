...
class Permissions(BaseSDK):
    ...
    def list_permissions(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.PermissionsListPermissionsResponse]:
        r"""List permissions
        ...
        **Required Permissions**
        ...
        def next_func() -> Optional[models.PermissionsListPermissionsResponse]:
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.PermissionsListPermissionsResponse(
    ...
    def list_roles(
        ...
        *,
        ...
        timeout_ms: Optional[int] = None,
        http_headers: Optional[Mapping[str, str]] = None,
    ) -> Optional[models.PermissionsListRolesResponse]:
        r"""List roles
        ...
        **Required Permissions**
        ...
        def next_func() -> Optional[models.PermissionsListRolesResponse]:
            body = utils.unmarshal_json(http_res.text, Union[Dict[Any, Any], List[Any]])
            next_cursor = JSONPath("$.pagination.cursor").parse(body)
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.PermissionsListRolesResponse(
                result=unmarshal_json_response(
