...
class Keys(BaseSDK):
    ...
    def migrate_keys(
        ...
        *,
        ...
        api_id: str,
        keys: Union[
            Iterable[models.V2KeysMigrateKeyData],
            Iterable[models.V2KeysMigrateKeyDataTypedDict],
        ],
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
    ...
    def update_key(
        ...
        *,
        ...
        meta: OptionalNullable[Mapping[str, Any]] = UNSET,
        ...
        **Side Effects**
        ...
        request = models.V2KeysUpdateKeyRequestBody(
            ...
            name=name,
            external_id=external_id,
            meta=utils.unmarshal(meta, OptionalNullable[Dict[str, Any]]),
            expires=expires,
        ...
        *,
        ...
        ratelimits: Optional[
            Union[
                ...
                Iterable[models.KeysVerifyKeyRatelimitTypedDict],
            ]
        ] = None,
