    ...
    def liveness(
        ...
        *,
        ...
        http_res = self.do_request(
            ...
            request=req,
            error_status_codes=["412", "4XX", "500", "5XX"],
            retry_config=retry_config,
        )

        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.V2LivenessResponseBody)
        if utils.match_response(http_res, "412", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.PreconditionFailedErrorResponseData
            )
            raise errors.PreconditionFailedErrorResponse(data=response_data)
