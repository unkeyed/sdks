...
class RatelimitSDK(BaseSDK):
    def limit(
        ...
        *,
        ...
        r"""
        :param namespace: The namespace name for the rate limit.
        :param duration: The duration in milliseconds for the rate limit window.
        :param identifier: The identifier for the rate limit.
        :param limit: The maximum number of requests allowed.
        :param cost: The cost of the request. Defaults to 1 if not provided.
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.V2RatelimitLimitResponseBody
            )
    ...
    def set_override(
        ...
        *,
        ...
        r"""
        :param duration: The duration in milliseconds for the rate limit window.
        :param identifier: Identifier of your user, this can be their userId, an email, an ip or anything else. Wildcards ( * ) can be used to match multiple identifiers, More info can be found at https://www.unkey.com/docs/ratelimiting/overrides#wildcard-rules
        :param limit: The maximum number of requests allowed.
        :param namespace_id: The id of the namespace. Either namespaceId or namespaceName must be provided
        :param namespace_name: The name of the namespace. Either namespaceId or namespaceName must be provided
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        :param timeout_ms: Override the default request timeout configuration for this method in milliseconds
        :param http_headers: Additional headers to set or replace on requests.
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.V2RatelimitSetOverrideResponseBody
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.BadRequestErrorResponseData
    ...
    def get_override(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.V2RatelimitGetOverrideResponseBody
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.BadRequestErrorResponseData
    ...
    def list_overrides(
        ...
        *,
        request: Union[
            ...
            models.V2RatelimitListOverridesRequestBodyTypedDict,
        ] = models.V2RatelimitListOverridesRequestBody(),
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        timeout_ms: Optional[int] = None,
        ...
        request = cast(models.V2RatelimitListOverridesRequestBody, request)
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                ...
                True,
                "json",
                Optional[models.V2RatelimitListOverridesRequestBody],
            ),
            timeout_ms=timeout_ms,
        )
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.V2RatelimitListOverridesResponseBody
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.BadRequestErrorResponseData
    ...
    def delete_override(
        ...
        *,
        ...
        r"""
        :param identifier: Identifier of the override to delete
        :param namespace_id: The id of the namespace. Either namespaceId or namespaceName must be provided
        :param namespace_name: The name of the namespace. Either namespaceId or namespaceName must be provided
        :param retries: Override the default retry configuration for this method
        :param server_url: Override the default server URL for this method
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.V2RatelimitDeleteOverrideResponseBody
            )
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(
                http_res.text, errors.BadRequestErrorResponseData
