...
from unkey_py.ratelimit_sdk import RatelimitSDK
from unkey_py.types import OptionalNullable, UNSET
import weakref


class Unkey(BaseSDK):
    ratelimit: RatelimitSDK
    ...
    def __init__(
        self,
        root_key: Union[str, Callable[[], str]],
    ...
    def _init_sdks(self):
        self.ratelimit = RatelimitSDK(self.sdk_configuration)
