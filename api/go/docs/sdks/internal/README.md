...
* [~~GetDeployment~~](#getdeployment) - Get deployment :warning: **Deprecated**
...
| `request`                                                                                                        | [components.V2DeployCreateDeploymentRequestBody](../../models/components/v2deploycreatedeploymentrequestbody.md) | :heavy_check_mark:                                                                                               | The request object to use for the request.                                                                       |
