...
func (s *Permissions) ListPermissions(ctx context.Context, request components.V2PermissionsListPermissionsRequestBody, opts ...operations.Option) (*operations.PermissionsListPermissionsResponse, error) {
	...
	res.Next = func() (*operations.PermissionsListPermissionsResponse, error) {
		rawBody, err := utils.ConsumeRawBody(httpRes)
		if err != nil {
			return nil, err
		}
...
func (s *Permissions) ListRoles(ctx context.Context, request components.V2PermissionsListRolesRequestBody, opts ...operations.Option) (*operations.PermissionsListRolesResponse, error) {
	...
	res.Next = func() (*operations.PermissionsListRolesResponse, error) {
		rawBody, err := utils.ConsumeRawBody(httpRes)
		if err != nil {
			return nil, err
		}
...
func (s *Permissions) SetRolePermissions(ctx context.Context, request components.V2PermissionsSetRolePermissionsRequestBodyUnion, opts ...operations.Option) (*operations.PermissionsSetRolePermissionsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/permissions.setRolePermissions")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.PermissionsSetRolePermissionsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2PermissionsSetRolePermissionsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2PermissionsSetRolePermissionsResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
