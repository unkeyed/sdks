...
func newDeploy(rootSDK *Unkey, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Deploy {
	return &Deploy{
		rootSDK:          rootSDK,
...
func (s *Deploy) CompleteUpload(ctx context.Context, request components.V2DeployCompleteUploadRequestBody, opts ...operations.Option) (*operations.DeployCompleteUploadResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/deploy.completeUpload")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "deploy.completeUpload",
		OAuth2Scopes:     nil,
	...
	res := &operations.DeployCompleteUploadResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2DeployCompleteUploadResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2DeployCompleteUploadResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
