...
func (s *Liveness) Liveness(ctx context.Context, opts ...operations.Option) (*operations.LivenessResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/liveness")
	if err != nil {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.sdkConfiguration.Hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"412", "4XX", "500", "5XX"}, httpRes.StatusCode) {
	...
	res := &operations.LivenessResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2LivenessResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2LivenessResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
