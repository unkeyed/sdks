...
// Github - GitHub App installation operations
type Github struct {
	rootSDK          *Unkey
...
func newGithub(rootSDK *Unkey, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Github {
	return &Github{
		rootSDK:          rootSDK,
...
func (s *Github) InstallApp(ctx context.Context, opts ...operations.Option) (*operations.GithubInstallAppResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/github.installApp")
	if err != nil {
	...
	res := &operations.GithubInstallAppResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2GithubInstallAppResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2GithubInstallAppResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
