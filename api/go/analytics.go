...
// GetGatewayRequests - Query gateway request data
...
func (s *Analytics) GetGatewayRequests(ctx context.Context, request components.V2AnalyticsGetGatewayRequestsRequestBody, opts ...operations.Option) (*operations.AnalyticsGetGatewayRequestsResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/analytics.getGatewayRequests")
	if err != nil {
	...
	hookCtx := hooks.HookContext{
		...
		BaseURL:          baseURL,
		Context:          ctx,
		OperationID:      "analytics.getGatewayRequests",
		OAuth2Scopes:     nil,
	...
	res := &operations.AnalyticsGetGatewayRequestsResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2AnalyticsGetGatewayRequestsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2AnalyticsGetGatewayRequestsResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// GetRatelimits - Query rate limit data
...
//
// If set, this operation will use [Security.RootKey] from the global security.
func (s *Analytics) GetRatelimits(ctx context.Context, request components.V2AnalyticsGetRatelimitsRequestBody, opts ...operations.Option) (*operations.AnalyticsGetRatelimitsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v2/analytics.getRatelimits")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.AnalyticsGetRatelimitsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2AnalyticsGetRatelimitsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2AnalyticsGetRatelimitsResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
// GetRuntimeLogs - Query runtime log data
...
//
// If set, this operation will use [Security.RootKey] from the global security.
func (s *Analytics) GetRuntimeLogs(ctx context.Context, request components.V2AnalyticsGetRuntimeLogsRequestBody, opts ...operations.Option) (*operations.AnalyticsGetRuntimeLogsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v2/analytics.getRuntimeLogs")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.AnalyticsGetRuntimeLogsResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2AnalyticsGetRuntimeLogsResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2AnalyticsGetRuntimeLogsResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
