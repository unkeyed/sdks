...
func newInternal(rootSDK *Unkey, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Internal {
	return &Internal{
		rootSDK:          rootSDK,
...
func (s *Internal) CreateDeployment(ctx context.Context, request operations.DeployCreateDeploymentRequest, opts ...operations.Option) (*operations.DeployCreateDeploymentResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/deploy.createDeployment")
	if err != nil {
	...
	res := &operations.DeployCreateDeploymentResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2DeployCreateDeploymentResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2DeployCreateDeploymentResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
//
// **Authentication**: Requires a valid root key with appropriate permissions.
func (s *Internal) GenerateUploadURL(ctx context.Context, request components.V2DeployGenerateUploadURLRequestBody, opts ...operations.Option) (*operations.DeployGenerateUploadURLResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
	...
	opURL, err := url.JoinPath(baseURL, "/v2/deploy.generateUploadUrl")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeployGenerateUploadURLResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2DeployGenerateUploadURLResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2DeployGenerateUploadURLResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Internal) GetDeployment(ctx context.Context, request components.V2DeployGetDeploymentRequestBody, opts ...operations.Option) (*operations.DeployGetDeploymentResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v2/deploy.getDeployment")
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.DeployGetDeploymentResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.V2DeployGetDeploymentResponseBody
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.V2DeployGetDeploymentResponseBody = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
