...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.683.1
...
func New(opts ...SDKOption) *Unkey {
	sdk := &Unkey{
		SDKVersion: "2.0.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 2.0.2 2.683.1 2.0.0 github.com/unkeyed/sdks/api/go/v2",
