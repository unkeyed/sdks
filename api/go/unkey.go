...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.669.0
...
func New(opts ...SDKOption) *Unkey {
	sdk := &Unkey{
		SDKVersion: "2.0.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 2.0.0 2.669.0 2.0.0 github.com/unkeyed/sdks/api/go/v2",
