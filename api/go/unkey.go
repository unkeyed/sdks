...
// Generated from OpenAPI doc version 2.0.0 and generator version 2.772.0
...
func New(opts ...SDKOption) *Unkey {
	sdk := &Unkey{
		SDKVersion: "2.3.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/go 2.3.0 2.772.0 2.0.0 github.com/unkeyed/sdks/api/go/v2",
