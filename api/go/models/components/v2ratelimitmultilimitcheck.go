...
func (v *V2RatelimitMultiLimitCheck) GetNamespace() string {
	if v == nil {
		return ""
	}
	return v.Namespace
...
func (v *V2RatelimitMultiLimitCheck) GetIdentifier() string {
	if v == nil {
		return ""
	}
	return v.Identifier
...
func (v *V2RatelimitMultiLimitCheck) GetLimit() int64 {
	if v == nil {
		return 0
	}
	return v.Limit
...
func (v *V2RatelimitMultiLimitCheck) GetRemaining() int64 {
	if v == nil {
		return 0
	}
	return v.Remaining
...
func (v *V2RatelimitMultiLimitCheck) GetReset() int64 {
	if v == nil {
		return 0
	}
	return v.Reset
...
func (v *V2RatelimitMultiLimitCheck) GetPassed() bool {
	if v == nil {
		return false
	}
	return v.Passed
...
func (v *V2RatelimitMultiLimitCheck) GetOverrideID() *string {
	if v == nil {
		return nil
	}
	return v.OverrideID
