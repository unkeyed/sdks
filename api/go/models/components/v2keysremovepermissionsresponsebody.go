...
func (v *V2KeysRemovePermissionsResponseBody) GetMeta() Meta {
	if v == nil {
		return Meta{}
	}
	return v.Meta
...
func (v *V2KeysRemovePermissionsResponseBody) GetData() []Permission {
	if v == nil {
		return []Permission{}
	}
	return v.Data
...
// #region class-body-v2keysremovepermissionsresponsebody
// #endregion class-body-v2keysremovepermissionsresponsebody
