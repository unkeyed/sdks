...
func (v *V2PortalGetPortalResponseBody) GetMeta() Meta {
	if v == nil {
		return Meta{}
	}
	return v.Meta
...
func (v *V2PortalGetPortalResponseBody) GetData() Portal {
	if v == nil {
		return Portal{}
	}
	return v.Data
...
// #region class-body-v2portalgetportalresponsebody
// #endregion class-body-v2portalgetportalresponsebody
