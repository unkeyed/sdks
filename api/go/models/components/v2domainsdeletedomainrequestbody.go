...
func (v *V2DomainsDeleteDomainRequestBody) GetDomain() string {
	if v == nil {
		return ""
	}
	return v.Domain
...
// #region class-body-v2domainsdeletedomainrequestbody
// #endregion class-body-v2domainsdeletedomainrequestbody
