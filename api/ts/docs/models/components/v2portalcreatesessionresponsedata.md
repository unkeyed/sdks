...
| `url`                                                                                                                                | *string*                                                                                                                             | :heavy_check_mark:                                                                                                                   | The full portal URL to redirect the end user to. Carries a single-use<br/>exchange code that is valid for 15 minutes.<br/>           | https://portal.unkey.com/?code=pec_abc123def456                                                                                      |