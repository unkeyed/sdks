...
| `meta`                                                                                                                               | Record<string, *any*>                                                                                                                | :heavy_minus_sign:                                                                                                                   | Custom metadata associated with this key.                                                                                            | null                                                                                                                                 |
...
| `lastUsedAt`                                                                                                                         | *number*                                                                                                                             | :heavy_minus_sign:                                                                                                                   | Unix timestamp in milliseconds when key was last used for verification. This is an approximated value, accurate to within 5 minutes. | 1701425400000                                                                                                                        |
