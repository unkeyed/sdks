...
```typescript
import { V2DeploymentsCreateDeploymentRequestBody1 } from "@unkey/api/models/components";

let value: V2DeploymentsCreateDeploymentRequestBody1 = {
...
| `image`                                                                                                                  | [components.DeploymentSourceImage](../../models/components/deploymentsourceimage.md)                                     | :heavy_check_mark:                                                                                                       | Deploy a prebuilt Docker image as-is.                                                                                    |                                                                                                                          |
