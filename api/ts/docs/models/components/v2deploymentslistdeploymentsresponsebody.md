...
```typescript
import { V2DeploymentsListDeploymentsResponseBody } from "@unkey/api/models/components";

let value: V2DeploymentsListDeploymentsResponseBody = {
  meta: {
    requestId: "req_123",
  },
  data: [
...
| `data`                                                                                                                                                                                                                                                          | [components.Deployment](../../models/components/deployment.md)[]                                                                                                                                                                                                | :heavy_check_mark:                                                                                                                                                                                                                                              | Array of deployments, ordered newest first.                                                                                                                                                                                                                     |
