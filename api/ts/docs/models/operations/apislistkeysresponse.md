...
```typescript
import { ApisListKeysResponse } from "@unkey/api/models/operations";

let value: ApisListKeysResponse = {
  result: {
    meta: {
      requestId: "req_123",
    },
...
| ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------- |
| `result`                                                                                       | [components.V2ApisListKeysResponseBody](../../models/components/v2apislistkeysresponsebody.md) | :heavy_check_mark:                                                                             | N/A                                                                                            |