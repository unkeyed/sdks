 ...
 */
export function keysAddRoles(
  client: UnkeyCore,
  request: components.V2KeysAddRolesRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2KeysAddRolesResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.V2KeysAddRolesRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.addRoles")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysAddRolesResponseBody$inboundSchema),
