...
export function internalCreateDeployment(
  ...
  Result<
    components.V2DeployCreateDeploymentResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      operations.DeployCreateDeploymentRequest$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/deploy.createDeployment")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(201, components.V2DeployCreateDeploymentResponseBody$inboundSchema),
