...
export function apisGetApi(
  ...
  Result<
    components.V2ApisGetApiResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.V2ApisGetApiRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/apis.getApi")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2ApisGetApiResponseBody$inboundSchema),
