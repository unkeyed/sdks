...
export function identitiesUpdateIdentity(
  ...
  Result<
    components.V2IdentitiesUpdateIdentityResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2IdentitiesUpdateIdentityRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/identities.updateIdentity")();
  ...
  >(
    M.json(
      200,
      components.V2IdentitiesUpdateIdentityResponseBody$inboundSchema,
    ),
