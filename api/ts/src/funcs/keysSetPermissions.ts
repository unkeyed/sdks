...
export function keysSetPermissions(
  ...
  Result<
    components.V2KeysSetPermissionsResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2KeysSetPermissionsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.setPermissions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysSetPermissionsResponseBody$inboundSchema),
