...
export function keysRemoveRoles(
  ...
  Result<
    components.V2KeysRemoveRolesResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2KeysRemoveRolesRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.removeRoles")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysRemoveRolesResponseBody$inboundSchema),
