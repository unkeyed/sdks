...
export function keysSetRoles(
  ...
  Result<
    components.V2KeysSetRolesResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.V2KeysSetRolesRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.setRoles")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysSetRolesResponseBody$inboundSchema),
