...
export function permissionsDeletePermission(
  ...
  Result<
    components.V2PermissionsDeletePermissionResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2PermissionsDeletePermissionRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/permissions.deletePermission")();
  ...
  >(
    M.json(
      200,
      components.V2PermissionsDeletePermissionResponseBody$inboundSchema,
    ),
