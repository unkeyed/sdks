 ...
 */
export function identitiesGetIdentity(
  client: UnkeyCore,
  request: components.V2IdentitiesGetIdentityRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2IdentitiesGetIdentityResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2IdentitiesGetIdentityRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/identities.getIdentity")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2IdentitiesGetIdentityResponseBody$inboundSchema),
