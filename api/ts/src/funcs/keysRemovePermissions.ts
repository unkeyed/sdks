...
export function keysRemovePermissions(
  ...
  Result<
    components.V2KeysRemovePermissionsResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2KeysRemovePermissionsRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.removePermissions")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysRemovePermissionsResponseBody$inboundSchema),
