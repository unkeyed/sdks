...
export function keysGetKey(
  ...
  Result<
    components.V2KeysGetKeyResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.V2KeysGetKeyRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.getKey")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysGetKeyResponseBody$inboundSchema),
