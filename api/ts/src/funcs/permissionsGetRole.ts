...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2PermissionsGetRoleRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/permissions.getRole")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2PermissionsGetRoleResponseBody$inboundSchema),
