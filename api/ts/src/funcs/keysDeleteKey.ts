...
export function keysDeleteKey(
  ...
  Result<
    components.V2KeysDeleteKeyResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2KeysDeleteKeyRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.deleteKey")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysDeleteKeyResponseBody$inboundSchema),
