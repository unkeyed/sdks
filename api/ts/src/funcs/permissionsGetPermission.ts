...
export function permissionsGetPermission(
  ...
  Result<
    components.V2PermissionsGetPermissionResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2PermissionsGetPermissionRequestBody$outboundSchema.parse(
        value,
      ),
  ...
  const path = pathToFunc("/v2/permissions.getPermission")();
  ...
  >(
    M.json(
      200,
      components.V2PermissionsGetPermissionResponseBody$inboundSchema,
    ),
