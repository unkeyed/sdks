...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2KeysCreateKeyRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/keys.createKey")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysCreateKeyResponseBody$inboundSchema),
