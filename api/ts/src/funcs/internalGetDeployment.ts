 ...
 */
export function internalGetDeployment(
  client: UnkeyCore,
  request: components.V2DeployGetDeploymentRequestBody,
  options?: RequestOptions,
): APIPromise<
  Result<
    components.V2DeployGetDeploymentResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2DeployGetDeploymentRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/deploy.getDeployment")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2DeployGetDeploymentResponseBody$inboundSchema),
