...
export function keysWhoami(
  ...
  Result<
    components.V2KeysWhoamiResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) => components.V2KeysWhoamiRequestBody$outboundSchema.parse(value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2KeysWhoamiResponseBody$inboundSchema),
