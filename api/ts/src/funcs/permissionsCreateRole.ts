...
export function permissionsCreateRole(
  ...
  Result<
    components.V2PermissionsCreateRoleResponseBody,
...
> {
  const parsed = safeParse(
    request,
    (value) =>
      components.V2PermissionsCreateRoleRequestBody$outboundSchema.parse(value),
  ...
  const path = pathToFunc("/v2/permissions.createRole")();
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, components.V2PermissionsCreateRoleResponseBody$inboundSchema),
