 ...
 */
export type ServiceUnavailableErrorResponseData = {
  /**
 ...
 * - Contact Unkey support if the issue continues
 */
export class ServiceUnavailableErrorResponse extends UnkeyError {
  /**
   * Metadata object included in every API response. This provides context about the request and is essential for debugging, audit trails, and support inquiries. The `requestId` is particularly important when troubleshooting issues with the Unkey support team.
   */
  meta: components.Meta;
  ...
  constructor(
    err: ServiceUnavailableErrorResponseData,
...
/** @internal */
export const ServiceUnavailableErrorResponse$inboundSchema: z.ZodType<
